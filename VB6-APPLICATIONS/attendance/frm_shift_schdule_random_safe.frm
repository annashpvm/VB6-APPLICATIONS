...
Begin VB.Form frm_shift_schdule_random_safe 
   Caption         =   "Shift Schedule - Random"
   ClientHeight    =   8805
   ClientLeft      =   60
   ClientTop       =   750
   ClientWidth     =   13725
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton exit 
         ...
         Left            =   1080
         MaskColor       =   &H000000FF&
         Picture         =   "frm_shift_schdule_random_safe.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton save 
         ...
         Left            =   360
         MaskColor       =   &H000000FF&
         Picture         =   "frm_shift_schdule_random_safe.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   120
         Width           =   735
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmb_weekoff 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_shift_schdule_random_safe.frx":0AAC
         Left            =   3120
         List            =   "frm_shift_schdule_random_safe.frx":0AAE
         TabIndex        =   25
         Top             =   1320
         Width           =   2535
      End
   ...
   Begin VB.Menu mnu_shift 
      ...
      Begin VB.Menu mnu_6to6_day 
         Caption         =   "6.00 to 6.00 (Day)"
      End
      Begin VB.Menu mnu_6to6_night 
         Caption         =   "6.00 to 6.00 (Night)"
      End
      Begin VB.Menu mnu_bc 
         Caption         =   "B+C"
      End
      Begin VB.Menu mnu_wo 
         Caption         =   "WO"
      End
   ...
   End
End
Attribute VB_Name = "frm_shift_schdule_random_safe"
...
With flx_data
For i = flx_data.Row To flx_data.RowSel
.TextMatrix(i, 2) = "6.00 to 6.00 (Day)"
Next
End With
End Sub
...
With flx_data
For i = flx_data.Row To flx_data.RowSel
.TextMatrix(i, 2) = "6.00 to 6.00 (Night)"
Next
End With
End Sub
