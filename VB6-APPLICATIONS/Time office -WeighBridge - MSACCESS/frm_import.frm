...
''    Set gen_connection_msaccess = Nothing
''    Set gen_connection_msaccess = New ADODB.Connection
''    gen_connection_msaccess.CursorLocation = adUseClient
''    gen_connection_msaccess.Open strcnn_mysql
...
''    mdb_qry = "Select *  from Tickets where Date = #" & Format(repDate.Value, "MM/dd/yyyy") & "# and  TicketNumber >= " & Val(txtTicketNo.Text) & " and State = 'Online Second Transaction'  order by TicketNumber"
 ...
 ''       MsgBox (CStr(mdbrs!TicketNumber) + " - " + mdbrs!VehicleNumber)
        ...
        If adors.RecordCount = 0 Then
            ...
            adocmd_msaccess.CommandTimeout = 300
            adocmd_msaccess.CommandText = pst_qry
