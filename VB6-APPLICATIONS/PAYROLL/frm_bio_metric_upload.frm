...
Begin VB.Form frm_bio_metric_upload 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.OptionButton opt2 
         Caption         =   "DATA FROM PUBLICDPM FOLDER"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.OptionButton opt1 
         Caption         =   "DATA FROM PERSONNEL DPM FOLDER"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
''    dsnmdb = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=d:\eTimeTrackLite1.mdb"
    ...
    Else
       dsnmdb = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=\\192.168.11.5\Publicdpm\biometri_data\eTimeTrackLite1.mdb"
    End If
...
''    mdb_qry = "Select a.EmployeeId,b.employeecode from attendancelogs as a, employees as b where a.EmployeeId =  b.EmployeeId  and a.Attendancedate between #" & Format(st_date, "MM/dd/yyyy") & "# and  #" & Format(end_date, "MM/dd/yyyy") & "# and b.Status = 'Working'  and b.employeecode = '5016'  group by a.EmployeeId,b.employeecode"
...
''    mdb_qry = "Select a.EmployeeId,b.employeecode,a.attendancedate,a.statuscode,a.intime,a.outtime,a.lateby,a.earlyby,a.overtime from attendancelogs as a, employees as b where a.EmployeeId =  b.EmployeeId  and b.employeecode = '5016' and a.Attendancedate between #" & Format(st_date, "MM/dd/yyyy") & "# and  #" & Format(end_date, "MM/dd/yyyy") & "# and b.Status = 'Working'  group by a.EmployeeId,b.employeecode,a.attendancedate,a.statuscode,a.intime,a.outtime,a.lateby,a.earlyby,a.overtime"
