...
Begin VB.Form tvlattn_entry 
   ...
   Begin VB.CommandButton save 
      ...
      Left            =   2280
      MaskColor       =   &H000000FF&
      Picture         =   "tvlattn_entry.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   6840
      Width           =   975
   ...
   Begin VB.CommandButton edit 
      ...
      Left            =   1320
      MaskColor       =   &H000000FF&
      Picture         =   "tvlattn_entry.frx":066A
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   6840
      Width           =   975
   ...
   Begin VB.CommandButton Refresh 
      ...
      Left            =   3240
      MaskColor       =   &H000000FF&
      Picture         =   "tvlattn_entry.frx":0CD4
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   6840
      Width           =   975
   ...
   Begin VB.CommandButton exit 
      ...
      Left            =   4200
      MaskColor       =   &H000000FF&
      Picture         =   "tvlattn_entry.frx":133E
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   6840
      Width           =   975
   ...
   Begin VB.CommandButton NEW 
      ...
      Left            =   360
      MaskColor       =   &H000000FF&
      Picture         =   "tvlattn_entry.frx":1780
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   6840
      Width           =   975
   ...
   End
End
Attribute VB_Name = "tvlattn_entry"
...
Private Sub Form_Load()
  ...
  If emptype_chk = 0 Then
     tvlattn_entry.Caption = "Daily Attendacne Entry for STAFF"
  Else
     tvlattn_entry.Caption = "Daily Attendacne Entry for WORKER"
  End If
  new_entry_chk = 0
...
''  pay = "Provider=SQLOLEDB.1;Password=serdat;Persist Security Info=True;User ID=sa;DATABASE=spl_others;Data Source=spplserver"
  ...
  Set payrs = New ADODB.Recordset
  If emptype_chk = 0 Then
     sql = ("Select * from  emp_mas where emp_company = '" & company_code & "' and (emp_type = 0 or emp_type = 1) and emp_work = 'TIRUNELVELI' order by emp_name")
  Else
     sql = ("Select * from  emp_mas where emp_company = '" & company_code & "' and (emp_type = 2 or emp_type = 3) and emp_work = 'TIRUNELVELI' order by emp_name")
  End If
  paydb.Open pay
  payrs.Open sql, paydb, adOpenDynamic, adLockOptimistic
  payrs.MoveFirst
