...
Begin VB.Form present_days 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Top             =   360
         Width           =   7320
         Begin VB.OptionButton opt_loff_abstract 
            Caption         =   " P.STOPPAGE DAYS ABSTRACT"
            Height          =   300
            Left            =   240
            TabIndex        =   22
            Top             =   1560
            Width           =   4395
         End
         Begin VB.OptionButton opt_loff_detailed 
            Caption         =   "P.STOPPAGE DAYS -DETAILED REPORT"
            Height          =   285
            Left            =   240
            TabIndex        =   21
            Top             =   1200
            Width           =   4095
         End
         Begin VB.OptionButton opt_pdays_detailed 
            Caption         =   " PRESENT DAYS -DETAILED REPORT"
            Height          =   285
            Left            =   240
            TabIndex        =   4
            Top             =   480
            Width           =   4095
         End
         Begin VB.OptionButton opt_pdays_abstract 
            Caption         =   " PRESENT DAYS ABSTRACT"
            Height          =   300
            Left            =   240
            TabIndex        =   3
            Top             =   840
   ...
   End
End
Attribute VB_Name = "present_days"
...
''   If opt_wp_pdays = True Then
        If opt_pdays_detailed.Value = True Then
            cry_rep1.ReportFileName = "\\10.0.0.252\vbcryrep\PAYROLL\present_days_worker.rpt"
            cry_rep1.Formulas(5) = ("cond = 0")
        ElseIf opt_loff_detailed.Value = True Then
            cry_rep1.ReportFileName = "\\10.0.0.252\vbcryrep\PAYROLL\present_days_worker.rpt"
            cry_rep1.Formulas(5) = ("cond = 1")
        ElseIf opt_pdays_abstract.Value = True Then
            cry_rep1.ReportFileName = "\\10.0.0.252\vbcryrep\PAYROLL\present_days_worker_abstract.rpt"
            cry_rep1.Formulas(5) = ("cond = 0")
        Else
            cry_rep1.ReportFileName = "\\10.0.0.252\vbcryrep\PAYROLL\present_days_worker_abstract.rpt"
            cry_rep1.Formulas(5) = ("cond = 1")
...
''   If opt_wp.Value = True Or opt_wp_pdays.Value = True Or opt_wp_layoff.Value = True Then
    If opt_pdays_abstract.Value = True Or opt_loff_abstract.Value = True Then
        cry_rep1.ReplaceSelectionFormula ("{emp_salary.s_finyear} = " & finyear & _
        "and {emp_salary.s_company} = " & company_code & " and {emp_mas.emp_type} in [ 2,3] and {emp_salary.s_salarydays} > 0  " & ds & "")
    Else
