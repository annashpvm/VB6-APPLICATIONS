...
On Error GoTo err_handler:
    ...
    adocmd_msaccess.ActiveConnection = gen_connection_msaccess
        ...
        pst_qry = "delete from mas_wb_settings_timeoffice where wb_port > 0"
        adocmd_msaccess.CommandText = pst_qry
        adocmd_msaccess.Execute pst_qry
        
        
        pst_qry = "insert into mas_wb_settings_timeoffice values ( " & Val(cmbPort.Text) & ", " & Val(txt_baudrate.Text) & ")"
        adocmd_msaccess.CommandText = pst_qry
        adocmd_msaccess.Execute pst_qry
