...
Begin VB.Form frm_shift_schdule_random 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmb_weekoff 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frm_shift_schdule_random.frx":0000
         Left            =   3120
         List            =   "frm_shift_schdule_random.frx":0002
         TabIndex        =   10
         Top             =   1320
         Width           =   2535
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton save 
         ...
         Left            =   360
         MaskColor       =   &H000000FF&
         Picture         =   "frm_shift_schdule_random.frx":0004
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   120
         Width           =   735
      ...
      Begin VB.CommandButton exit 
         ...
         Left            =   1080
         MaskColor       =   &H000000FF&
         Picture         =   "frm_shift_schdule_random.frx":066E
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   120
         Width           =   735
   ...
   End
End
Attribute VB_Name = "frm_shift_schdule_random"
