...
Private Sub Form_Load()
  ...
  If emptype_chk = 0 Then
     atten_ent.Caption = "Daily Attendacne Entry for STAFF"
  Else
     atten_ent.Caption = "Daily Attendacne Entry for WORKER"
  End If
  new_entry_chk = 0
