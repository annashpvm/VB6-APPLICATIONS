...
Private Sub cmd_print_Click()
            ...
            qry = "{trn_weighbridge_entry.t_wb_compcode}  =  " & compcode & " and  {trn_weighbridge_entry.t_wb_year}  =  " & gin_finid & " and   {trn_weighbridge_entry.t_wb_ticketno}  =  " & cmb_TicketNo.Text
...
Function get_Tickets()
 ...
 ''   yy = 24
    ...
    pst_qry = "select * from trn_weighbridge_entry where t_wb_compcode = " & compcode & "  and  t_wb_year =  " & gin_finid & "  and t_wb_date = #" & Format(dt_ticket, "MM-dd-yyyy") & "# "
